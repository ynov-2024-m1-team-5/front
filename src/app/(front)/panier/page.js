...
const Page = () => {
    ...
    const products= Array(3).fill({
        ...
        name: "Produit 1",
        price: 100,
        image: "https://images.pexels.com/photos/2407409/pexels-photo-2407409.jpeg?auto=compress&cs=tinysrgb&w=600",
        quantity: 5
    });
            ...
            <div className="max-w-6xl mx-auto px-4 pb-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="md:col-span-2">
                       {products.map((product)=>(<ul className="divide-y divide-gray-200">
                            <li
                                key=""
