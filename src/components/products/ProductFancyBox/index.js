    ...
    return (
        <div className="fixed flex justify-center text-center bg-white w-full h-full py-8 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[9999]">
            ...
            <button
                onClick={close}
                type="button"
                className="absolute right-1/4 bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
            >
